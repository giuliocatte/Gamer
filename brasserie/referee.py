...
DECK = [  # type, name, points, tracks modifiers
    ...
    ("Carne", "Galletto arrosto", 2, (1, 0, 1)),
    ("Carne", "Crocchette di pollo", 3, (1, 0, 3)),
    ("Carne", "La Salsiccia", 5, (-2, 0, 2)),
    ("Carne", "Filetto", 5, (-1, 0, 2)),
    ("Carne", "Hamburgherino", 6, (-2, 0, 3)),
    ...
    ("Panini", "Crudo e mozzarella", 1, (1, 0, 1)),
    ("Panini", "Vegetariano", 4, (-2, 0, 1)),
    ("Panini", "Cotto e funghi", 4, (-1, 0, 2)),
    ("Panini", "Speck e brie", 5, (-1, 0, 3)),
    ("Panini", "Porchetta", 7, (-2, 0, 4)),
]
